...
import nuxt_plugin_plugin_1f5827d9 from 'nuxt_plugin_plugin_1f5827d9' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_pluginclient_1b3f4256 from 'nuxt_plugin_pluginclient_1b3f4256' // Source: ./content/plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_5819d05d from 'nuxt_plugin_pluginserver_5819d05d' // Source: ./content/plugin.server.js (mode: 'server')
import nuxt_plugin_pluginrouting_e86c8812 from 'nuxt_plugin_pluginrouting_e86c8812' // Source: ./nuxt-i18n/plugin.routing.js (mode: 'all')
import nuxt_plugin_pluginmain_25968ad8 from 'nuxt_plugin_pluginmain_25968ad8' // Source: ./nuxt-i18n/plugin.main.js (mode: 'all')
import nuxt_plugin_workbox_356ab46a from 'nuxt_plugin_workbox_356ab46a' // Source: ./workbox.js (mode: 'client')
import nuxt_plugin_metaplugin_6a72f1de from 'nuxt_plugin_metaplugin_6a72f1de' // Source: ./pwa/meta.plugin.js (mode: 'all')
import nuxt_plugin_pluginserver_d15bcd26 from 'nuxt_plugin_pluginserver_d15bcd26' // Source: ./color-mode/plugin.server.js (mode: 'server')
import nuxt_plugin_pluginclient_3198a7e5 from 'nuxt_plugin_pluginclient_3198a7e5' // Source: ./color-mode/plugin.client.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_1f5827d9 === 'function') {
    await nuxt_plugin_plugin_1f5827d9(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_1b3f4256 === 'function') {
    await nuxt_plugin_pluginclient_1b3f4256(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_5819d05d === 'function') {
    await nuxt_plugin_pluginserver_5819d05d(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginrouting_e86c8812 === 'function') {
    await nuxt_plugin_pluginrouting_e86c8812(app.context, inject)
  }

  if (typeof nuxt_plugin_pluginmain_25968ad8 === 'function') {
    await nuxt_plugin_pluginmain_25968ad8(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_workbox_356ab46a === 'function') {
    await nuxt_plugin_workbox_356ab46a(app.context, inject)
  }

  if (typeof nuxt_plugin_metaplugin_6a72f1de === 'function') {
    await nuxt_plugin_metaplugin_6a72f1de(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_d15bcd26 === 'function') {
    await nuxt_plugin_pluginserver_d15bcd26(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_3198a7e5 === 'function') {
    await nuxt_plugin_pluginclient_3198a7e5(app.context, inject)
  }
